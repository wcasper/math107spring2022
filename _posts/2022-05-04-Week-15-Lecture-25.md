...
In other words, if we know something about the value of $$w$$ or $$\ell$$, then we could predict with good accuracy the other value using the fact that

$$\binom{w}{\ell} \approx \alpha\binom{0.9999528}{0.00971388}$$
...
$$w \approx 0.9999528\alpha,\quad\text{and}\quad \ell \approx 0.00971388\alpha,$$

for some unknown constant $$\alpha$$.  After a little algebra, we can get rid of this constant to find

$$\ell \approx \frac{0.00971388}{0.9999528}w.$$

This is the equation of a straight line through the origin!
